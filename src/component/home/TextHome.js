import multipagoOferta from '../../assets/img/logo__oferta.png'
import delivery from '../../assets/img/img_delivery.png'

const TextHome = ({skipHome}) => (
    <div className="text-center home__text">
        ...
        <p className="text-white w-100 d-block mb-5 home__text--p">
            para realizar tu pedido por medio de servicios de <span className="enfasis">DELIVERY</span>
        </p>
